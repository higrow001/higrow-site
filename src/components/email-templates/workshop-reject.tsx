...
export const WorkshopRejectTemplate: React.FC<Readonly<EmailTemplateProps>> = ({
  ...
  Your workshop got Rejected!
            ...
            <Text className="text-black text-[14px] leading-[24px]">
              We're so sorry to say that you're workshop "{workshopName}" is rejected by our team! But you can still create another and try to provide actualt information!  
              </Text>
              <Button
                pX={20}
                pY={12}
