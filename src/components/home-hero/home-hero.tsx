...
const HomeHero = () => {
  return (
    ...
    <Link className="hbottom-links" href="#"><button>Give Us Feedback</button></Link>
    </div>
  <div className="hbottom-center">
<p>  We’re an early stage startup so your feedback or suggestions means a lot to us :) </p>
  </div>
  <div className="hbottom-right">
  <Link className="hbottom-links" href="#"><button>Give Us Suggestions</button></Link>
  </div>
    </div>
  </div>
  )
