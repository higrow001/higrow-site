...
export default async function AdminManage() {
  ...
  if (workshops?.length === 0)
    return (
      <>
       <Navbar />
        <p className="pt-[130px]">No workshops or contests to approve right now.</p>{" "}
      </>
    )
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col pt-[100px] max-w-7xl w-full my-20 mx-auto space-y-8">
            ...
            <React.Fragment key={i}>
              <Dialog>
                <div className="flex w-full py-4 px-4 items-center border border-input bg-background rounded-md divide-x-2 divide-input">
                  ...
                  <AdminActionBtns
                    workshop_title={document.name}
                    workshop_id={document.id}
                    ...
                    <aside className="basis-[35%] h-full p-8 space-y-8">
                      <div className="space-y-6">
                        ...
                        <span className="flex space-x-2 items-center">
                          ...
                          <span>{document.session_start_time}</span>
                        </span>
                        <span className="flex space-x-2 items-center">
                          <span className="font-semibold">
                            Session ends on -
                          </span>
                          <span>{document.session_end_time}</span>
                        </span>
