...
export default function notFound() {
  return (
    <main className="h-full w-full flex justify-center items-center flex-col space-y-8 px-6">
      <h1 className="font-archivo font-bold text-center text-4xl lg:text-6xl">Oh no... We lost this page</h1>
      ...
      <Link href={"/"}>
        <Button className="px-6 rounded-lg" size={"xl"}>Back to Home</Button>
      </Link>
    </main>
  )
}
