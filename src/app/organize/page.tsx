...
export default function Organize() {
  return (
    ...
    <Link href="/organize/workshop">    <div className='workshop-card'>
        ...
        <Link href="/organize/contest">    <div className='contest-card'>
          <div className='card-image'>
          ...
          <div className='card-text'>
            <h1>Contest</h1>
          <p>Contests is an organized event in which people try to win something.</p>
          </div>
